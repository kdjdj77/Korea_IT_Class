 ...
 */
public class DB05Main implements QueryMySql {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 2. 쿼리연산(들) 수행
			stmt.executeUpdate("INSERT INTO test_member VALUE(123, 'aaa', now())");
			stmt.executeUpdate("INSERT INTO test_member VALUE(456, 'bbb', now())");
			stmt.executeUpdate("INSERT INTO test_member VALUE(789, 'ccc', now())");
			stmt.executeUpdate("INSERT INTO test_member VALUE('abc', 'ddd', now())");
			stmt.executeUpdate("INSERT INTO test_member VALUE(1012, 'eee', now())");
